...
public class DormantAcctReact extends LogIn {
	
	@AfterTest
	
	@SuppressWarnings("deprecation")
	public void ReactivateDormAccount () throws InterruptedException {
	
	driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div/nav/div[1]/div[1]/a[14]/div")).click();
	
	driver.findElement(By.id("mui-component-select-dormantAccountType")).click();
	driver.findElement(By.xpath("//*[@id=\"menu-dormantAccountType\"]/div[3]/ul/li[3]")).click();
