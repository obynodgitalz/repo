...
public class TransfersToFABAccountsBen extends LogIn {
	...
	Thread.sleep(10000);
	driver.findElement(By.xpath("//*[@id=\"simple-tab-1\"]/span[1]")).click();	
	...
	driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div[1]/div/div/form/div[2]/div[2]/div[1]/div/div/div/div/div/div")).click();
...
driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div[1]/div/div/form/div[3]/div/button")).click();
	...
	driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div/section/div[2]/button[2]")).click();
